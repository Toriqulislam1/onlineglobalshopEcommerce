...
<header class="box-shadow-sm rtl">
   ...
   <div class="topbar">
    ...
    <div class="navbar-sticky bg-light mobile-head">
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu" style="background-color: #c22026" >
            <div class="container" style="padding-left: 10px;padding-right: 10px;">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        @endif
                        <li>
                                    <a class="nav-link"  href="https://play.google.com/store/apps/details?id=com.ogs.globalshop&hl=en&gl=US" download>App Download</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- Messenger Chat Plugin Code -->
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "111989013658628");
