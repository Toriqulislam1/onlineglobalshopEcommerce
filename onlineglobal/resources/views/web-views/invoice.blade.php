...
<div class="first" style="display: block; height:auto !important;background-color: #E6E6E6">
    ...
    <table class="bs-0">
        <tr>
            <th class="bg-primary content-position-y" style="padding-right: 0; height: 24px; text-align: left">
                <div>
            ...
            <th class="bg-secondary content-position-y" style="text-align: right; height: 20px;">
                <span class="h4 inline"
                      style="color: #030303;padding-right: 7px;">{{\App\CPU\translate('date')}} : </span>
            ...
            <tr>
                <td valign="top">
                    ...
                    <div class="h4 montserrat-normal-600">
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->customer['f_name'].' '.$order->customer['l_name']}}</p>
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->customer['email']}}</p>
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->customer['phone']}}</p>
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->shippingAddress ? $order->shippingAddress['address'] : ""}}</p>
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->shippingAddress ? $order->shippingAddress['city'] : ""}} {{$order->shippingAddress ? $order->shippingAddress['zip'] : ""}}</p>
                ...
                <td valign="top">
                    ...
                    <div class="h4 montserrat-normal-600">
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->billingAddress ? $order->billingAddress['contact_person_name'] : ""}}</p>
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->billingAddress ? $order->billingAddress['phone'] : ""}}</p>
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->billingAddress ? $order->billingAddress['address'] : ""}}</p>
                        <p style=" margin-top: 2px; margin-bottom:0px;">{{$order->billingAddress ? $order->billingAddress['city'] : ""}} {{$order->billingAddress ? $order->billingAddress['zip'] : ""}}</p>
